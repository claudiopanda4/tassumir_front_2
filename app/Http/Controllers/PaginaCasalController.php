...
class PaginaCasalController extends Controller
{
    ...
    public function index(){
        ...
        //dd($page_content);
        return view('pagina.couple_page', compact('account_name','conta_logada', 'page_content', 'tipo_relac', 'seguidores', 'publicacoes', 'checkUserStatus', 'profile_picture', 'isUserHost', 'hasUserManyPages', 'allUserPages'));
    }
    ...
    public function my_pages(){
        try {
            ...
            $conta_logada = $auth->defaultDate();
            //dd($page_content);
            return view('pagina.pages', compact('account_name', 'conta_logada', 'page_content', 'tipo_relac', 'seguidores', 'publicacoes', 'checkUserStatus', 'profile_picture', 'hasUserManyPages', 'allUserPages'));
        } catch (Exception $e) {
            dd($e);
        }
    ...
    public function edit_couple(){
        try {
            ...
            $allUserPages = AuthController::allUserPages(new AuthController, $account_name[0]->conta_id);
            $conta_logada = $auth->defaultDate();
            return view('pagina.edit_couple', compact('account_name', 'conta_logada', 'checkUserStatus', 'profile_picture', 'isUserHost', 'hasUserManyPages', 'allUserPages'));
        } catch (Exception $e) {
            dd($e);
        }
    }
    ...
    public function delete_couple_page(){
        try {
            ...
            return view('pagina.delete_couple_page', compact('account_name', 'conta_logada', 'checkUserStatus', 'profile_picture', 'hasUserManyPages', 'allUserPages'));
        } catch (Exception $e) {
            dd($e);
        }
    }
