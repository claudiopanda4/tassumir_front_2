            ...
            <div class="" id="main-reg">
                ...
                <form action="{{route('account.verifyCode.enter')}}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="input-text-default input-full input-login" name="codeReceived" placeholder="Enviamos um Código de Verificação no teu Email" id="codeReceived" required>
