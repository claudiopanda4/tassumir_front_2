	...
	<div class="body-pop-up content-full-scroll-t">
		...
		<div class="main " style="margin-top:10%;text-align: justify;">
			...
			<span class="span-text color-white" style="justify-content:flex-start;">
				...
				Todos os dias, as pessoas utilizam o Tassumir para partilhar as suas experiências, criar comunidades e estar em contacto com amigos e família. É um serviço onde várias pessoas se expressam livremente em várias culturas e idiomas.
				
			</span>
			<span class="span-text color-white" style="justify-content:flex-start;">
				
				A empresa do Tassumir reconhece que é muito importante ser um local onde as pessoas se sentem motivadas para comunicar e leva a sério o seu papel de impedir o abuso no serviço. É por essa razão que aplicamos normas sobre aquilo que é ou não permitido no Tassumir.
			</span>
			<span  class="span-text color-white" style="justify-content:flex-start;">
			Estas normas são baseadas no feedback das pessoas e no conselho de especialistas em áreas como a tecnologia, a segurança pública e os direitos humanos. Para garantirmos que a voz de todos é valorizada, temos muito cuidado a criar normas que incluem diferentes visões e crenças, especialmente as de pessoas e comunidades que podem de outra forma ser ignoradas ou marginalizadas.
			</span>

			<span  class="span-text color-white" style="justify-content:flex-start;">
			O objectivo dos nossos Padrões da Comunidade é criar um local de expressão e dar voz às pessoas sobretudo em seus relacionamentos conjugais. A empresa Be Able, Lda pretende que as pessoas consigam falar abertamente sobre os problemas que lhes interessam, mesmo que algumas possam discordar ou considerá-los inconvenientes. Em alguns casos, permitimos conteúdos que, de outra forma, seriam contrários às nossas normas, se forem mediáticos e de acordo com o interesse público. Fazemo-lo apenas depois de analisarmos o nível do interesse público em relação ao risco de danos e consultamos as normas dos direitos humanos internacionais para fazermos estes juízos.
			</span>
			<span  class="span-text color-white" style="justify-content:flex-start;">
			O objectivo dos nossos Padrões da Comunidade é criar um local de expressão e dar voz às pessoas sobretudo em seus relacionamentos conjugais. A empresa Be Able, Lda pretende que as pessoas consigam falar abertamente sobre os problemas que lhes interessam, mesmo que algumas possam discordar ou considerá-los inconvenientes. Em alguns casos, permitimos conteúdos que, de outra forma, seriam contrários às nossas normas, se forem mediáticos e de acordo com o interesse público. Fazemo-lo apenas depois de analisarmos o nível do interesse público em relação ao risco de danos e consultamos as normas dos direitos humanos internacionais para fazermos estes juízos.
			</span>
			<span class="span-text color-white" style="justify-content:flex-start;">
				...
				<span style="border-left: 4px solid #800080;padding: 5px;margin-top: 15px;margin-bottom: 15px;padding: 5px;margin-left: 5px">c) Conteúdos que são permitidos com um ecrã de aviso ou conteúdos que são permitidos, mas só podem ser vistos por adultos com idade igual ou superior a 18 anos. (atenção execucão, colectivo)</span>
