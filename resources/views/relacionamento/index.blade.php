...
<div class="main" id="main-container-relationship">
    <div class="card">
      @if($pedido[0]['estado'] == 2 || $pedido[0]['estado'] == 6)
        <div class="clearfix">
            ...
            <div>
                <div class="options-invited clearfix">
                    ...
                    @if($pedido[0]['estado'] != 6)
                    <form class="needs-validation" action="{{route('Outra_pessoa')}}" method="post" novalidate>
                        @csrf

                    <button type="submit" name="button" class="l-5 denied">Pedir que o outro lado pague</button>
                    <input type="hidden" name="p_id" id="p_id" value="{{$pedido[0]['pedido_relacionamento_id']}}">
                    <input type="hidden" name="n_id" id="n_id" value="{{$pedido[0]['not']}}">
                  </form>
                  @endif
                </div>
            </div>
